...
List<OnBoardingModel>onboarding=[
  ...
  OnBoardingModel(
      ...
      body:'In Uptodo you can create your personalized routine to stay active'
  ),
  OnBoardingModel(
      title:'Organize your tasks',
      body: 'you can organize your daily tasks by adding your task into separate categories'
  ),
];
